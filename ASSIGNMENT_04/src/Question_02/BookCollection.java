...
public class BookCollection
{
	...
	private void init() 
	{
		books.add(new Book(10, "Rich dad Poor dad", "Robert T Kiyosaki"));
		books.add(new Book(29, "Wings of Fire", "Dr.A.P.J.Abdul Kalam"));
		books.add(new Book(55, "The secret", "Rhonda Byrne"));
	}
